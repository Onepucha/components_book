<template lang="html">
  ...
  >
    ...
    <div class="input-select-con" v-model="valueFilter">
      ...
      <i
        class="icon material-icons icon-select vs-select--icon"
        v-if="!activeBtnClear"
        >{{ icon }}</i
      >
...
export default {
  ...
  props: {
    ...
    */
    noData: {
      default: "Данные не определены",
      type: String,
    },
    /**
    Максимальное количество вариантов, которые можно выбрать (только для 'multiple').
    */
    maxSelected: {
      default: null,
      type: [Number, String],
    ...
    /**
    Позволяет использовать автозаполнение при выборе.
    */
    autocomplete: {
      default: false,
      type: Boolean,
    ...
    */
    ...
    /**
    Определяет, является ли выделение множественным выбором.
    */
    multiple: {
      default: false,
      type: Boolean,
    ...
    */
    ...
    /**
    Добавляет текст описания для ввода
    */
    descriptionText: {
      default: null,
      type: String,
